 ...
 * </copyright>
 *
 * $Id: AomSwitch.java,v 1.9 2011-02-07 08:36:33 igsong Exp $
 */
 ...
 * @generated
 */
public class AomSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AomPackage.ABSTRACT_OBJECT_MODEL: {
				AbstractObjectModel abstractObjectModel = (AbstractObjectModel)theEObject;
				T result = caseAbstractObjectModel(abstractObjectModel);
				if (result == null) result = caseMeasurableElement(abstractObjectModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AomPackage.MEASURABLE_ELEMENT: {
				MeasurableElement measurableElement = (MeasurableElement)theEObject;
				T result = caseMeasurableElement(measurableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AomPackage.STRING_TO_OBJECT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Object Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Object Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAbstractObjectModel(AbstractObjectModel object) {
		return null;
	}
