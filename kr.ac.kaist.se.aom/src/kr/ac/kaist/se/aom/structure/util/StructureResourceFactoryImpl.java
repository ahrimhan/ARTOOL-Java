 ...
 * </copyright>
 *
 * $Id: StructureResourceFactoryImpl.java,v 1.1 2011-01-18 07:51:59 igsong Exp $
 */
package kr.ac.kaist.se.aom.structure.util;

import java.util.Map;

import kr.ac.kaist.se.aom.util.AomResourceImpl;
 ...
 * <!-- end-user-doc -->
 * @see kr.ac.kaist.se.aom.structure.util.StructureResourceImpl
 * @generated
 */
public class StructureResourceFactoryImpl extends ResourceFactoryImpl {
	...
	public Resource createResource(URI uri) {
		StructureResourceImpl resource = new StructureResourceImpl(uri);
