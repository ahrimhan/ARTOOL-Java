...
/**
 * This is the item provider adapter for a {@link kr.ac.kaist.se.aom.structure.AOMNamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AOMNamedElementItemProvider
	 ...
	 * @generated
	 */
	public AOMNamedElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AOMNamedElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AOMNamedElement_type") :
			getString("_UI_AOMNamedElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AOMNamedElement.class)) {
