...
//	public static final String NMOB = "NMOB"; //overridden by
	...
	//message-level, a() a() �̷��� a() �ι� count vs.
	//method-level, a() a() �̷��� a() �ѹ� count
	...
	//new(20110421)
	public static final String MPCDE = "MPCDE"; //"Message" Passing Coupling (DynamicMethodCalls���� export + import & distinct�Ѱ͸� ��.) 
	public static final String MPCDI = "MPCDI";
	public static final String MPCDBoth = "MPCDBoth";
	//new(20110511)
	public static final String MPCSE = "MPCSE"; //"Method" Passing Coupling (StaticMethodCalls���� export + import & distinct�Ѱ͸� ��.) 
